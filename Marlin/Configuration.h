...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_IVI_STM32F407VE
#endif
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 110.61
  #define DEFAULT_bedKi 20.95
  #define DEFAULT_bedKd 389.36
...
#define DELTA
  ...
  #define DELTA_DIAGONAL_ROD 357.5        // (mm)

  // Distance between bed and nozzle Z home position
  #define DELTA_HEIGHT 259.5             // (mm) Get this value from G33 auto calibrate
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 800, 800, 800, 1150 }  // default steps per unit for Kossel (GT2, 20 tooth)
...
//#define LIMITED_MAX_FR_EDITING        // Limit edit via M203 or LCD to DEFAULT_MAX_FEEDRATE * 2
  ...
  #define MAX_FEEDRATE_EDIT_VALUES    { 1000, 1000, 1000, 200 } // ...or, set your own edit limits
#endif
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { 0, 45, -2 }
...
#define POS_MARGIN 0
#define X_MIN_POS -(DELTA_PRINTABLE_RADIUS) + POS_MARGIN
#define Y_MIN_POS -(DELTA_PRINTABLE_RADIUS) + POS_MARGIN
#define Z_MIN_POS 0
#define X_MAX_POS DELTA_PRINTABLE_RADIUS - POS_MARGIN
#define Y_MAX_POS DELTA_PRINTABLE_RADIUS - POS_MARGIN
...
#define HOMING_FEEDRATE_Z  (4*600)
