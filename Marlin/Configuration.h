...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_IVI_CONTROLLER
#endif

// Name displayed in the LCD "Ready" message and Info menu
#define CUSTOM_MACHINE_NAME "IVI"
...
#define DELTA
  ...
  #define DELTA_DIAGONAL_ROD 350.17        // (mm)

  // Distance between bed and nozzle Z home position
  #define DELTA_HEIGHT 230.60             // (mm) Get this value from G33 auto calibrate

  #define DELTA_ENDSTOP_ADJ { 0.0, 0.0, 0.0 } // Get these values from G33 auto calibrate

  // Horizontal distance bridged by diagonal push rods when effector is centered.
  #define DELTA_RADIUS 138.73              // (mm) Get this value from G33 auto calibrate
...
#define XYZ_FULL_STEPS_PER_ROTATION 400 // 200 for 1.8 stepper, 400 for 0.9 stepper
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, 237 }  // default steps per unit for Kossel (GT2, 20 tooth)
